...
public class GetterSetterVerifier<T> {
    ...
    /**
     * Creates a getter / setter verifier to test properties for a particular
     * class.
     *
     * @param type
     *            The class that we are testing
     */
    public GetterSetterVerifier(final Class<T> type) {
        this.type = type;
    }

    /**
     * Method used to identify the properties that we are going to test. If no
     * includes are specified, then all the properties are considered for
     * testing.
     *
     * @param include
     *            The name of the property that we are going to test.
     ...
     *
     * @param exclude
     *            The name of the property that we are going to ignore.
     * @return This object, for method chaining.
     */
    ...
    /**
     * Determine if we need to test the property based on a few conditions. 1.
     * The property has both a getter and a setter. 2. The property was not
     * excluded. 3. The property was considered for testing.
     *
     * @param property
     *            The property that we are determining if we going to test.
     ...
     *
     * @param property
     *            The property that we are testing.
     *
     ...
     *
     * @param type
     *            The class that we are testing the getters and setters for.
     * @return An object that can be used for testing the getters and setters of
     *         a class.
     */
